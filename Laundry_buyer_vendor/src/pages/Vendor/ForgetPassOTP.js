...
const VendorForgetPassOTP = ({navigation, route}) => {
  ...
  const verifyregistraion = () => {
    ...
    axios
      .post('/vendor/VendorsApi/validate_password_otp', body)
      .then(response => {
        setData({
          ...data,
          loading: false,
        ...
        if (response.data.status == 1) {
            navigation.navigate('VendorResetPassword', {
                email : email
            });
        }
      })
    ...
    <ScrollView style={styles.background}>
      <View style={styles.background}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.subtitle}>Enetr the OTP sent to 9876543210</Text>
...
export default VendorForgetPassOTP;
