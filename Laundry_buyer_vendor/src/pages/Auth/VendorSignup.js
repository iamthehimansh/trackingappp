...
const VendorSignupScreen = ({navigation}) => {
    ...
    const registerHandle = () => {
        ...
        let body = "name=" + data.name + "&password=" + data.password + "&email=" + data.email + "&mobile=" + data.mobile + '&addesss=' + data.address + '&company_name=' + data.company_name;
        axios.post('/vendor/VendorsApi/register', body)
          .then((response) => {
            setData({
                ...data,
                loading : false
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.header}>
            <Text style={styles.text_header}>Register your store!</Text>
        </View>
        <Animatable.View 
        ...
        >
            ...
            <View style={styles.action}>
                ...
                <TextInput 
                    ...
                    style={styles.textInput}
                    autoCapitalize="none"
                    onChangeText={(val) => setData({...data, company_name : val})}
                />
            </View>
